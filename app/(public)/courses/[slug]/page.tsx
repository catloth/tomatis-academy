      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-semibold tracking-tight">Descrição</h2>
            <RenderDescription json={JSON.parse(course.description)} />
          </div>
        </div>
        <div className="mt-12 space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-semibold tracking-tight">Conteúdo</h2>
            <div>
              {course.chapters.length} módulos |{" "}
                      ...
                      <CardContent className="p-6 hover:bg-muted/50 transition-colors">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <IconChevronDown className="size-5 text-muted-foregound" />
                          </div>
                        </div>
                      </CardContent>
                    </div>
                        ...
                        {chapter.lessons.map((lesson, lessonIndex) => (
                          ...
                          >
                            <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-primary/20">
                              <IconPlayerPlay className="size-4 text-muted-foreground group-houver:text-primary transition-colors" />
                            </div>
          ...
          <Card className="py-0">
            <CardContent className="p-6">
              ...
              <div className="mb-6 space-y-3 rounded-lg bg-muted p-4">
                <h4 className="font-medium">O que você receberá:</h4>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Duração do curso</p>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Grau de dificuldade</p>
                      <p className="text-sm text-muted-foreground">
                        {course.level}
                      </p>
                    </div>
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>
                      Disponível no seu computador, tablet ou smartfone
                    </span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full p-1 bg-green-500/10 text-green-500">
