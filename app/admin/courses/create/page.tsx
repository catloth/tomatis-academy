...
export default function CourseCreationPage() {
  ...
  const form = useForm<CourseSchemaType>({
    ...
    defaultValues: {
      ...
      duration: 0,
      level: "Beginner",
      category: "Saúde e Cuidado Pessoal",
      status: "Draft",
      slug: "",
      smallDescription: "",
    },
  ...
  return (
    <>
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">Crie um curso</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Informações básicas</CardTitle>
          <CardDescription>Forneça as informações gerais sobre o curso que está criando.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="w-full">
                    ...
                    <FormControl>
                      <Textarea placeholder="Descrição resumida" className="min-h-[120px]" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                    ...
                    <FormItem className="w-full">
                      <FormLabel>Dificuldade</FormLabel>
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          <FormControl>
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder="Selecione um nível de complexidade" />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
              ...
              <Button type="submit" disabled={isPending}>
                {isPending ? (
                  ...
                  <>
                    Criar curso <PlusIcon className="ml-1" size={16} />
                  </>
                )}
              </Button>
            </form>
